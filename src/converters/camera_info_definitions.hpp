...
inline sensor_msgs::CameraInfo createCameraInfoTOPVGA()
{
  ...
  float kTab[nK] = {556.845054830986, 0, 309.366895338178,
                    0, 555.898679730161, 230.592233628776,
                    0, 0, 1};

  float dTab[nD] = {-0.0545211535376379,
                    0.0691973423510287,
                    -0.00241094929163055 ,
                    -0.00112245009306511,
                    0};
  ...
  float pTab[nP] = {551.589721679688, 0, 308.271132841983, 0,
...
inline sensor_msgs::CameraInfo createCameraInfoTOPQVGA()
{
  ...
  float kTab[nK] = {274.139508945831, 0, 141.184472810944,
                    0, 275.741846757374, 106.693773654172,
                    0, 0, 1 };

  float dTab[nD] = {-0.0870160932911717,
                    0.128210165050533,
                    0.003379500659424,
                    -0.00106205540818586,
                    0};
  ...
  float pTab[nP] = {272.423675537109, 0, 141.131930791285, 0,
...
inline sensor_msgs::CameraInfo createCameraInfoTOPQQVGA()
{
  ...
  float kTab[nK] = {139.424539568966, 0, 76.9073669920582,
                    0, 139.25542782325, 59.5554242026743,
                    0, 0, 1 };

  float dTab[nD] = {-0.0843564504845967,
                    0.125733083790192,
                    0.00275901756247071,
                    -0.00138645823460527,
                    0};
  ...
  float pTab[nP] = {137.541534423828, 0, 76.3004646597892, 0,
...
inline sensor_msgs::CameraInfo createCameraInfoBOTTOMVGA()
{
  ...
  float kTab[nK] = {558.570339530768, 0, 308.885375457296,
                    0, 556.122943034837, 247.600724811385,
                    0, 0, 1};

  float dTab[nD] = {-0.0648763971625288,
                    0.0612520196884308,
                    0.0038281538281731,
                    -0.00551104078371959,
                    0};
  ...
  float pTab[nP] = {549.571655273438, 0, 304.799679526441, 0,
...
inline sensor_msgs::CameraInfo createCameraInfoBOTTOMQVGA()
{
  ...
  float kTab[nK] = {278.236008818534, 0, 156.194471689706,
                    0, 279.380102992049, 126.007123836447,
                    0, 0, 1};

  float dTab[nD] = {-0.0481869853715082,
                    0.0201858398559121,
                    0.0030362056699177,
                    -0.00172241952442813,
                    0};
  ...
  float pTab[nP] = {273.491455078125, 0, 155.112454709117, 0,
...
inline sensor_msgs::CameraInfo createCameraInfoBOTTOMQQVGA()
{
  ...
  float kTab[nK] = {141.611855886672, 0, 78.6494086288656,
                    0, 141.367163830175, 58.9220646201529,
                    0, 0, 1};

  float dTab[nD] = {-0.0688388724945936,
                    0.0697453843669642,
                    0.00309518737071049,
                    -0.00570486993696543,
                    0};
  ...
  float pTab[nP] = {138.705535888672, 0, 77.2544255212306, 0,
...
inline sensor_msgs::CameraInfo createCameraInfoDEPTHVGA()
{
  ...
  float kTab[nK] = {525, 0, 319.5000000,
  ...
  float pTab[nP] = {525, 0, 319.500000, 0,
...
inline sensor_msgs::CameraInfo createCameraInfoDEPTHQVGA()
{
  ...
  float kTab[nK] = {525/2.0f, 0, 319.5000000/2.0f,
                    0, 525/2.0f, 239.5000000000000/2.0f,
                    0, 0, 1 };
  ...
  float pTab[nP] = {525/2.0f, 0, 319.500000/2.0f, 0,
                    0, 525/2.0f, 239.5000000000/2.0f, 0,
                    0, 0, 1, 0 };
...
inline sensor_msgs::CameraInfo createCameraInfoDEPTHQQVGA()
{
  ...
  float kTab[nK] = {525/4.0f, 0, 319.5000000/4.0f,
                    0, 525/4.0f, 239.5000000000000/4.0f,
                    0, 0, 1};
  ...
  float pTab[nP] = {525/4.0f, 0, 319.500000/4.0f, 0,
                    0, 525/4.0f, 239.5000000000/4.0f, 0,
                    0, 0, 1, 0};
